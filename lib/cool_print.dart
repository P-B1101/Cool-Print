...
class CoolPrinter {
  ...
  static Stream<String> _findLetter(
    String letter,
    int duration,
  ...
  static void _printMessage(String message, String? header) {
    _clearConsole();
    if (header != null) print(header);
    print(message);
  }

  static void _clearConsole() => print('\x1B[2J\x1B[0;0H');

  static Future<void> _delay(int duration) =>
